...
class TestCase(LiveServerTestCase):
    ...
    def test_identification_detection(self):
        ...
        time.sleep(10)
        self.driver.find_element_by_name("image").send_keys('/Users/ziran/Develop/Git_file/AI-plateform-server/functional_tests/images/fox.jpg')
        self.driver.find_element_by_xpath('//*[@id="app"]/div[1]/button').click()
        time.sleep(5)
        r50_res_1 = self.driver.find_element_by_xpath('//*[@id="showprediction"]')
        self.assertIn('Prediction: red_fox', r50_res_1.text)
        self.driver.find_element_by_name("image").send_keys('/Users/ziran/Develop/Git_file/AI-plateform-server/functional_tests/images/panda0.jpg')
        self.driver.find_element_by_xpath('//*[@id="app"]/div[1]/button').click()
        time.sleep(5)
